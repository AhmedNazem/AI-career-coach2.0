...
const FeaturesSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative z-10 py-16 md:py-32 bg-background">
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            {/* Card 1: AI Success Rate */}
            <Card data-reveal className="feature-card relative col-span-full flex overflow-hidden lg:col-span-2">
            ...
            <Card data-reveal className="feature-card relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <Briefcase className="m-auto size-12 text-cyan-400" strokeWidth={1} />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Practice with AI-generated role-specific questions and
                    receive instant, actionable feedback to ace your next
                    interview.
                  </p>
                </div>
              </CardContent>
            ...
            {/* Card 3: Industry Insights with chart */}
            <Card data-reveal className="feature-card relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop
                          className="text-cyan-500/15 dark:text-cyan-400/35"
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Stay ahead with live salary trends, market demand analytics,
                    and growth forecasts tailored to your target industry.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Card 4: AI-Powered Guidance with chart visualization */}
            <Card data-reveal className="feature-card relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <BrainCircuit className="m-auto size-5" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Get personalized career advice, skill gap analysis, and
                      strategic roadmaps powered by advanced AI.
                    </p>
                  </div>
                </div>
                <div className="rounded-tl-lg relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                  ...
                  >
                    <path
                      ...
                      fill="url(#paint0_linear_guidance)"
                    />
                    <path
                      className="text-cyan-500 dark:text-cyan-400"
            ...
            {/* Card 5: Smart Resume Builder */}
            <Card data-reveal className="feature-card relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <ScrollText className="m-auto size-6" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium transition">
                    ...
                    <p className="text-muted-foreground">
                      Generate ATS-optimized resumes with AI that highlights
                      your strengths and matches job requirements.
                    </p>
                  </div>
                </div>
                <div className="before:bg-border relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      ...
                      <div className="ring-background flex size-7 items-center justify-center rounded-full bg-emerald-500/20 ring-4">
                        <LineChart className="size-3.5 text-emerald-500" />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-background flex size-8 items-center justify-center rounded-full bg-cyan-500/20 ring-4">
                    ...
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      ...
                      <div className="ring-background flex size-7 items-center justify-center rounded-full bg-violet-500/20 ring-4">
                        <ScrollText className="size-3.5 text-violet-400" />
                      </div>
                    </div>
                  </div>
                </div>
